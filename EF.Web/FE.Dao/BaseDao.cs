...
namespace FE.Dao
{
...

    {
        ...
        public virtual T UpdateEntity(T entity)
        {
            ...
            objectContext.ObjectStateManager.ChangeObjectState(entity, EntityState.Modified);//将附加的对象状态更改为修改
            objectContext.SaveChanges();
            return entity;
        }
        ...
        {
            objectContext.CreateObjectSet<T>().Attach(entity);
            objectContext.ObjectStateManager.ChangeObjectState(entity, EntityState.Deleted);//将附加的实体状态更改为删除
